...
# can also be S-type and I-type in a P-type frame. To decide the type,
# we compare the entropy of the blocks of the residue image resulting
# from the substraction of the current frame and the current
# prediction frame, with the entropy of the blocks of the current
# frame. If for a given block the residue has a higher entropy, then
# the block is intra-coded. Only the luma is considered. I-type blocks
# are generated by discarding the corresponding prediction blocks. The
